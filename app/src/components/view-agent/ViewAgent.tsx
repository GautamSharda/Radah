...
export default function ViewAgent({ showControls, agent, switchingAgent }: ViewAgentProps) {
    return (
        <main className="flex-grow flex flex-col relative h-screen p-4">
            ...
            {agent ? (
                <VncViewer showControls={showControls} agent={agent} switchingAgent={switchingAgent} />
            ) : (
